...
export const icons = {
	...
	buster: (
		<svg
			...
			viewBox="0 0 16 16"
		>
			<path d="M 5,1.5 H 11 c 1.93,0 3.5,1.93 3.5,3.5 V 11 c 0,1.93 -1.5,3.5 -3.5,3.5 H 5 C 3,14.5 1.5,13 1.5,11 l 0,-6 C 1.5,3 3,1.5 5,1.5 Z" />
			<path style={{ strokeLinecap: "round" }} d="m 4.5,6.5 v 2 m 3,-2 v 2" />
			<path d="m 1.5,10.5 h 13" />
		</svg>
	),
	...
	arrowRight: <Arrow rotation={90} />,
	arrowDown: <Arrow rotation={180} />,
	arrowLeft: <Arrow rotation={270} />,
	...
	// https://icons.getbootstrap.com/icons/arrows-collapse-vertical/
	fold: (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="16"
